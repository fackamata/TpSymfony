 ...
 */
final class Version20210927100542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enchere (id INT AUTO_INCREMENT NOT NULL, oeuvre_id INT DEFAULT NULL, user_id INT DEFAULT NULL, date DATETIME NOT NULL, prix INT NOT NULL, INDEX IDX_38D1870F88194DE8 (oeuvre_id), INDEX IDX_38D1870FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, lieu_id INT NOT NULL, nom VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, date DATETIME NOT NULL, image VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, prix_entree DOUBLE PRECISION DEFAULT NULL, INDEX IDX_B26681E6AB213CC (lieu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('CREATE TABLE evenement_oeuvre (evenement_id INT NOT NULL, oeuvre_id INT NOT NULL, INDEX IDX_860BFE7C88194DE8 (oeuvre_id), INDEX IDX_860BFE7CFD02F13 (evenement_id), PRIMARY KEY(evenement_id, oeuvre_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE oeuvre (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, artiste_id INT DEFAULT NULL, nom VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, description LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, date_creation DATETIME NOT NULL, prix INT NOT NULL, INDEX IDX_35FE2EFE21D25844 (artiste_id), INDEX IDX_35FE2EFEC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE evenement_oeuvre');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
